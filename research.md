...
When this large-scale flow is absent or suppressed, large-scale localized structures disappear, and turbulence contaminates the flow via the propagation or retraction of small-scale vortices. This propagation scenario, arising in curved, body-forced pipes or controlled Couette flow, occurs via fluctuating turbulent fronts. Surprisingly, while exhibiting a different propagation mechanism than in classical pipe or planar flows, these systems may still obey the same universal statistics. 
