...
When this large-scale flow is absent or suppressed, large-scale localized structures disappear, and turbulence contaminates the flow via the propagation or retraction of small-scale vortices. This propagation scenario, arising in curved, body-forced pipes or <a href="https://journals.aps.org/prl/abstract/10.1103/PhysRevLett.132.264002" class="keyword">controlled Couette flow</a>, occurs via fluctuating turbulent fronts. Surprisingly, while exhibiting a different propagation mechanism than in classical pipe or planar flows, these systems may still obey the same universal statistics. 
