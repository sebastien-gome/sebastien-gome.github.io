...
Turbulence in wall-bounded shear flows (like pipe, plane Couette or plane Poiseuille flow) is generated by the latter, making them subcritical. There, turbulence emerges by occupying an increasing proportion of space as the flow forcing (i.e the Reynolds number) is increased. 
